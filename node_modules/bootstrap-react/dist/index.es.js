import React__default, { memo, createContext, forwardRef, useRef, useEffect, useContext, createElement, Fragment, Component, useMemo, useCallback, cloneElement, useState, Children, isValidElement, useLayoutEffect } from 'react';
...
var _a$1$1, _b;
var AnimatePropComponents = (_a$1$1 = {},
    _a$1$1[AnimatePropType.Target] = makeRenderlessComponent(function (_a) {
    ...
    _a$1$1[AnimatePropType.VariantLabel] = makeRenderlessComponent(function (_a) {
    ...
    _a$1$1[AnimatePropType.AnimationSubscription] = makeRenderlessComponent(function (_a) {
...
const useSharedState = (input, handler) => {
    const [state, set] = useState(input);
    return [handler ? input : state, handler || set];
};
...
const Button = forwardRef((_a, ref) => {
    var { component: Component = "button", children, size, disabled, layout, variant, color = "primary", className = "", active } = _a, props = __rest(_a, ["component", "children", "size", "disabled", "layout", "variant", "color", "className", "active"]);
    ...
    if (props.href) {
        ...
        return (React__default.createElement("a", Object.assign({}, props, additionalProps, { className: className, role: "button" }), children));
    }
    if (props.value) {
        return (React__default.createElement("input", Object.assign({}, Object.assign(Object.assign({}, props), { size: undefined }), additionalProps, { className: className })));
    }
    return (React__default.createElement(Component, Object.assign({}, props, additionalProps, { className: className }), children));
});

const Close = forwardRef((_a, ref) => {
    var { children, component: Component = Button } = _a, props = __rest(_a, ["children", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { variant: "close", "aria-label": "close", ref: ref }),
        React__default.createElement("span", { "aria-hidden": "true" }, "\u00D7")));
});

const Alert = forwardRef((_a, ref) => {
    var { color = "primary", dismissable, children, onDismiss, onDismissed, visible = true, className = "" } = _a, divProps = __rest(_a, ["color", "dismissable", "children", "onDismiss", "onDismissed", "visible", "className"]);
    ...
    return (React__default.createElement(AnimatePresence, { initial: false }, _visible && (React__default.createElement(motion.div, Object.assign({}, divProps, { ref: ref, initial: false, exit: { opacity: 0 }, onAnimationComplete: onDismissed, className: className, role: "alert" }),
        children,
        isDismissable && React__default.createElement(Close, { onClick: () => set(false) })))));
});

const AlertHeading = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "h4" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({ ref: ref }, props, { className: `alert-heading ${className}` }), children));
});

const AlertLink = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "a" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { ref: ref, className: `alert-link ${className}` }), children));
});

const Badge = forwardRef((_a, ref) => {
    var { children, variant = "rectangle", color = "primary", className = "", component: Component = "span" } = _a, props = __rest(_a, ["children", "variant", "color", "className", "component"]);
    className = classnames(`badge bg-${color} ${className}`, {
        "text-dark": color === "light",
        "rounded-pill": variant === "pill"
    });
    return (React__default.createElement(Component, Object.assign({}, props, { className: className, ref: ref }), children));
});

const Breadcrumb = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("nav", { "aria-label": "breadcrumb", ref: ref },
        React__default.createElement("ol", Object.assign({ className: `breadcrumb ${className}` }, props), children)));
});

const BreadcrumbItem = forwardRef((_a, ref) => {
    var { active, className = "", children } = _a, props = __rest(_a, ["active", "className", "children"]);
    ...
    return (React__default.createElement("li", Object.assign({ className: className }, listItemProps, { ref: ref }), props.href ? React__default.createElement("a", Object.assign({}, props), children) : children));
});

const ButtonGroup = forwardRef((_a, ref) => {
    var { children, size, orientation = "horizontal", className = "" } = _a, props = __rest(_a, ["children", "size", "orientation", "className"]);
    ...
    return (React__default.createElement("div", Object.assign({}, props, { className: className, role: "group", ref: ref }), children));
});

const ButtonToolbar = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `btn-toolbar ${className}`, role: "toolbar", ref: ref }), children));
});

const Card = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card ${className}`, ref: ref }), children));
});

const CardBody = forwardRef((_a, ref) => {
    var { children, className = "", orientation } = _a, props = __rest(_a, ["children", "className", "orientation"]);
    className = classnames(className, {
        "card-body": orientation !== "overlay",
        "card-img-overlay": orientation === "overlay"
    });
    return (React__default.createElement("div", Object.assign({}, props, { className: className, ref: ref }), children));
});

const CardFooter = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card-footer ${className}`, ref: ref }), children));
});

const CardGroup = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card-group ${className}`, ref: ref }), children));
});

const CardHeader = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `card-header ${className}`, ref: ref }), children));
});

const CardImage = forwardRef((_a, ref) => {
    var { orientation, className = "" } = _a, props = __rest(_a, ["orientation", "className"]);
    className = classnames(className, {
        "card-img": orientation !== "top",
        "card-img-top": orientation === "top"
    });
    return React__default.createElement("img", Object.assign({}, props, { className: className, ref: ref }));
});

const CardLink = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "a" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `card-link ${className}`, ref: ref }), children));
});

const CardSubtitle = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "h6" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `card-subtitle ${className}`, ref: ref }), children));
});

const CardText = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "p" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `card-text ${className}`, ref: ref }), children));
});

const CardTitle = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "h5" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `card-title ${className}`, ref: ref }), children));
});

const SR = forwardRef(({ children, className = "" }, ref) => (React__default.createElement("span", { className: `sr-only ${className}`, ref: ref }, children)));
...
const useSizeToBreakpoint = (size) => {
    if (!size)
        return;
    return sizes$1[size];
};
...
const useMeasure = () => {
    ...
    const [observer] = useState(() => new index$2((entries) => {
...
const Carousel = forwardRef((_a, ref) => {
    var { className = "", indicators = true, controls = true, index = 0, transition = "slide", useGestures = true, interval = 5000 } = _a, props = __rest(_a, ["className", "indicators", "controls", "index", "transition", "useGestures", "interval"]);
    ...
    useEffect(() => {
        function updateFrames() {
            ...
            const index = xval < trailingx.get() ? Math.ceil(position) : Math.floor(position);
            if (page !== index) {
                setPage(index);
            }
            trailingx.set(xval);
    ...
    return (React__default.createElement("div", { className: `carousel ${className}`, ref: ref },
        indicators && (React__default.createElement("ol", { className: "carousel-indicators" }, children.map((_item, i) => (React__default.createElement("li", { key: i, className: i === wrap(0, children.length, page) ? "active" : "", onClick: () => {
        ...
        React__default.createElement("div", { className: "carousel-inner", ref: measureRef },
            React__default.createElement(motion.div, { key: index, drag: "x", style: { x }, dragMomentum: false, onDragStart: () => clearTimeout(timeout.current), onDragEnd: ({}, { offset, velocity }) => {
        ...
        controls && (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("a", { className: "carousel-control-prev", href: "#", role: "button", "data-slide": "prev", onClick: (e) => {
                    e.preventDefault();
                    x.set(-page * width + width);
                } },
                React__default.createElement("span", { className: "carousel-control-prev-icon", "aria-hidden": "true" }),
                React__default.createElement(SR, null, "Previous")),
            React__default.createElement("a", { className: "carousel-control-next", href: "#", role: "button", "data-slide": "next", onClick: (e) => {
                    e.preventDefault();
                    x.set(-page * width - width);
                } },
                React__default.createElement("span", { className: "carousel-control-next-icon", "aria-hidden": "true" }),
                React__default.createElement(SR, null, "Next"))))));
});
/**
...
const curryRange$1 = (func) => (min, max, v) => (v !== undefined ? func(min, max, v) : (cv) => func(min, max, cv));
const wrapFn = (min, max, v) => {
    const rangeSize = max - min;
    return ((((v - min) % rangeSize) + rangeSize) % rangeSize) + min;
};
const wrap = curryRange$1(wrapFn);

const CarouselCaption = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { style: { transition: "none" }, className: `carousel-caption ${className}`, ref: ref }), children));
});

const CarouselItem = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `carousel-item active ${className}`, ref: ref }), children));
});

const Accordion = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `accordion ${className}`, ref: ref }), children));
});

const Collapse = forwardRef(({ visible, className = "", children }, ref) => {
    return (React__default.createElement(motion.div, { ref: ref, key: "content", initial: false, animate: visible ? "open" : "collapsed", exit: "collapsed", variants: {
            open: {
                opacity: 1,
                height: "auto",
        ...
        }, transition: { ease: [0.15, 0.72, 0.34, 1], duration: 0.2 }, className: `collapse ${visible ? "show" : ""} ${className}` }, children));
});

const DropdownMenu = forwardRef((_a, ref) => {
    var { children, visible, alignment = "left", className = "" } = _a, props = __rest(_a, ["children", "visible", "alignment", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { ref: ref, className: `dropdown-menu ${visible ? "show" : ""} ${alignment === "right" ? "dropdown-menu-right" : ""} ${className}` }), children));
});

const DropdownToggle = forwardRef((_a, ref) => {
    var { children, split, className, component: Component = Button } = _a, props = __rest(_a, ["children", "split", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `dropdown-toggle ${split ? "dropdown-toggle-split" : ""} ${className}`, ref: ref }),
        children,
        split && React__default.createElement(SR, null, "Toggle Dropdown")));
});

const NavLinkToggle = forwardRef((_a, ref) => {
    var { children, className, onClick } = _a, props = __rest(_a, ["children", "className", "onClick"]);
    return (React__default.createElement("a", Object.assign({}, props, { onClick: (e) => {
            e.preventDefault();
            onClick && onClick(e);
        }, href: "#", className: `nav-link dropdown-toggle ${className}`, ref: ref }), children));
});

let counter = 0;
const Dropdown = forwardRef((_a, forwardedRef) => {
    var { alignment = "left", direction = "down", variant = "dropdown", className = "", trigger = "click", onToggle, children, action, toggle } = _a, props = __rest(_a, ["alignment", "direction", "variant", "className", "trigger", "onToggle", "children", "action", "toggle"]);
    ...
    const toggleProps = Object.assign({ id, "aria-haspopup": true, "aria-expanded": visible }, trig
        .map((t) => triggers[t])
        .reduce((obj, item) => {
        for (let i in item)
            obj[i] = item[i];
    ...
    const toggler = typeof toggle === "string"
        ? (p) => variant === "nav-item" ? (React__default.createElement(NavLinkToggle, Object.assign({}, p), toggle)) : (React__default.createElement(DropdownToggle, Object.assign({}, p), toggle))
        : toggle;
    return (React__default.createElement("div", Object.assign({ ref: ref }, props, { className: `dropdown ${variant} ${dropDirection} ${className}` }),
        action,
        toggler(toggleProps),
        visible && (React__default.createElement("div", { onClick: () => set(false), style: {
                top: 0,
                left: 0,
                right: 0,
                bottom: 0,
        ...
        React__default.createElement(DropdownMenu, { alignment: alignment, visible: visible, "aria-labelledby": id, onClick: () => set(!visible) }, children)));
});

const DropdownDivider = forwardRef((_a, ref) => {
    var { children } = _a, props = __rest(_a, ["children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: "dropdown-divider", ref: ref }), children));
});

const DropdownHeader = forwardRef((_a, ref) => {
    var { children, component: Component = "h6" } = _a, props = __rest(_a, ["children", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: "dropdown-header", ref: ref }), children));
});

const DropdownItem = forwardRef((_a, ref) => {
    var { children, component: Component = "a" } = _a, props = __rest(_a, ["children", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: "dropdown-item", ref: ref }), children));
});

const DropdownItemText = forwardRef((_a, ref) => {
    var { children, component: Component = "span" } = _a, props = __rest(_a, ["children", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: "dropdown-item-text", ref: ref }), children));
});

const Icon = forwardRef((_a, ref) => {
    var { name, path = "bootstrap-icons.svg", size = 32, color, className } = _a, props = __rest(_a, ["name", "path", "size", "color", "className"]);
    return (React__default.createElement("svg", Object.assign({ ref: ref, className: `bi text-${color} ${className}`, width: size, height: size, fill: "currentColor" }, props),
        React__default.createElement("use", { href: `${path}#${name}` })));
});

const ListGroup = forwardRef((_a, ref) => {
...
const ListGroupItem = forwardRef((_a, ref) => {
    var { children, className = "", active, disabled, color, href, type } = _a, itemProps = __rest(_a, ["children", "className", "active", "disabled", "color", "href", "type"]);
    const props = Object.assign(Object.assign({}, itemProps), { ref });
    ...
    return type === "button" ? (React__default.createElement("button", Object.assign({}, props, { disabled: disabled }), children)) : href ? (React__default.createElement("a", Object.assign({}, props, { href: href }), children)) : (React__default.createElement("div", Object.assign({}, props), children));
});

const ModalBackdrop = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement(motion.div, Object.assign({}, props, { className: `modal-backdrop ${className}`, ref: ref }), children));
});

const ModalDialog = forwardRef((_a, ref) => {
    var { className = "", children, scrollable, alignment } = _a, props = __rest(_a, ["className", "children", "scrollable", "alignment"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-dialog 
...
const ModalContent = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-content ${className}`, ref: ref }), children));
});

const Modal = forwardRef(({ className = "", visible, children, transition = "tween", onDismiss, scrollable = false, alignment = "top", animationVariants, }, ref) => {
    useEffect(() => {
        if (visible) {
    ...
    return (React__default.createElement(AnimatePresence, null,
        visible && (React__default.createElement(ModalBackdrop, { key: "backdrop", initial: "hidden", animate: "visible", exit: "hidden", variants: {
                hidden: { opacity: 0 },
                visible: { opacity: 0.5 },
            }, className: "show" })),
        visible && (React__default.createElement(motion.div, { ref: ref, onClick: onDismiss, key: "modal", initial: "hidden", animate: "visible", exit: "hidden", variants: animationVariants || {
                hidden: {
                    opacity: 0,
            ...
            }, className: `modal show ${className}`, tabIndex: -1, role: "dialog", style: { display: "block" } },
            React__default.createElement(ModalDialog, { onClick: (e) => e.stopPropagation(), className: "show", scrollable: scrollable, alignment: alignment },
                React__default.createElement(ModalContent, null, children))))));
});

const ModalBody = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-body ${className}`, ref: ref }), children));
});

const ModalFooter = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-footer ${className}`, ref: ref }), children));
});

const ModalHeader = forwardRef((_a, ref) => {
    var { className = "", children, onDismiss } = _a, props = __rest(_a, ["className", "children", "onDismiss"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `modal-header ${className}`, ref: ref }),
        children,
        onDismiss && React__default.createElement(Close, { onClick: onDismiss })));
});

const ModalTitle = forwardRef((_a, ref) => {
    var { className = "", children, component: Component = "h5" } = _a, props = __rest(_a, ["className", "children", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `modal-title ${className}`, ref: ref }), children));
});

const Nav = forwardRef((_a, ref) => {
    var { children, className = "", variant, layout } = _a, props = __rest(_a, ["children", "className", "variant", "layout"]);
    className = classnames(`nav ${className}`, {
        [`nav-${variant}`]: variant,
        [`nav-${layout}`]: layout
    });
    return (React__default.createElement("ul", Object.assign({}, props, { className: className, role: "navigation", ref: ref }), children));
});

const NavLink = forwardRef((_a, ref) => {
    var { children, disabled, className = "", active, component: Component = "a" } = _a, props = __rest(_a, ["children", "disabled", "className", "active", "component"]);
...
const NavItem = forwardRef((_a, ref) => {
    ...
    if (href) {
        children = (React__default.createElement(NavLink, Object.assign({ className: className, href: href }, props), children));
        className = "";
    }
    return (React__default.createElement("li", { className: `nav-item ${className}`, ref: ref }, children));
});

const TabContent = forwardRef((_a, ref) => {
    var { index = 0, className = "", onTab } = _a, props = __rest(_a, ["index", "className", "onTab"]);
    const children = React__default.Children.toArray(props.children);
    return (React__default.createElement("div", Object.assign({}, props, { className: `tab-content ${className}`, role: "navigation", ref: ref }),
        React__default.createElement(AnimatePresence, { initial: false, exitBeforeEnter: true, onExitComplete: onTab },
            React__default.createElement(motion.div, { key: index, variants: {
                    enter: {
                        opacity: 0,
                    },
                    center: {
                ...
                }, initial: "enter", animate: "center", exit: "exit" }, React__default.cloneElement(children[index], {
                className: "active",
            })))));
});

const TabPane = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `tab-pane ${className} active`, role: "tabpanel", ref: ref }), children));
});

const NavbarBrand = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "a" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `navbar-brand ${className}`, ref: ref }), children));
});

const NavbarToggler = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "button" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `navbar-toggler ${className}`, type: "button", "aria-label": "Toggle navigation", ref: ref }),
        React__default.createElement("span", { className: "navbar-toggler-icon" })));
});

const SimpleNavBar = forwardRef((_a, ref) => {
    var { children, set, brand } = _a, p = __rest(_a, ["children", "set", "brand"]);
    return (React__default.createElement(React__default.Fragment, null,
        typeof brand === "string" ? (React__default.createElement(NavbarBrand, { href: "#" }, brand)) : (brand),
        React__default.createElement(NavbarToggler, { onClick: () => set(!p.visible) }),
        React__default.createElement(Collapse, Object.assign({}, p, { ref: ref }), children)));
});

const Navbar = forwardRef((_a, ref) => {
    var { children, className = "", color = "light", expand = "sm", container, brand } = _a, props = __rest(_a, ["children", "className", "color", "expand", "container", "brand"]);
    const size = useWindowSize();
    ...
    let navChildren = children && isFunction(children) ? (children(childProps)) : (React__default.createElement(SimpleNavBar, Object.assign({}, childProps, { brand: brand }), children));
    if (container) {
        navChildren = (React__default.createElement("div", { className: `container${container !== true ? "-" + container : ""}` }, navChildren));
    }
    return (React__default.createElement("nav", Object.assign({}, props, { className: `navbar ${className}`, role: "navigation", ref: ref }), navChildren));
});

const NavbarNav = forwardRef((_a, ref) => {
    var { children, className = "" } = _a, props = __rest(_a, ["children", "className"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `navbar-nav ${className}`, role: "navigation", ref: ref }), children));
});

const NavbarText = forwardRef((_a, ref) => {
    var { children, className = "", component: Component = "span" } = _a, props = __rest(_a, ["children", "className", "component"]);
    return (React__default.createElement(Component, Object.assign({}, props, { className: `navbar-text ${className}`, role: "navigation", ref: ref }), children));
});
...
const Pagination = forwardRef((_a, ref) => {
    ...
    return (React__default.createElement("nav", Object.assign({}, props, { ref: ref }),
        React__default.createElement("ul", { className: className }, children)));
});

const PaginationItem = forwardRef((_a, ref) => {
    var { children, className = "", active, disabled, href = "#", component: Component = "a" } = _a, props = __rest(_a, ["children", "className", "active", "disabled", "href", "component"]);
    if (disabled) {
        props.tabIndex = -1;
        props["aria-disabled"] = "true";
    }
    return (React__default.createElement("li", { className: `page-item ${active ? "active" : ""} ${disabled ? "disabled" : ""}` },
        React__default.createElement(Component, Object.assign({ className: `page-link ${className}`, href: href }, props, { ref: ref }), children)));
});
...
function Manager(_ref) {
  ...
  return /*#__PURE__*/createElement(ManagerReferenceNodeContext.Provider, {
    value: referenceNode
  }, /*#__PURE__*/createElement(ManagerReferenceNodeSetterContext.Provider, {
...
function getClientRectFromMixedType(element, clippingParent) {
  return clippingParent === viewport$1 ? rectToClientRect(getViewportRect(element)) : isHTMLElement$2(clippingParent) ? getInnerBoundingClientRect(clippingParent) : rectToClientRect(getDocumentRect(getDocumentElement(element)));
    ...
    var instance = {
      ...
      setOptions: function setOptions(options) {
        ...
        if (process.env.NODE_ENV !== "production") {
          ...
          if (getBasePlacement(state.options.placement) === auto$1) {
...
function Popper(_ref) {
  ...
  var referenceNode = useContext(ManagerReferenceNodeContext);
...
function Reference(_ref) {
  var children = _ref.children,
      innerRef = _ref.innerRef;
  var setReferenceNode = useContext(ManagerReferenceNodeSetterContext);
  var refHandler = useCallback(function (node) {
...
const PopoverElement = forwardRef((_a, ref) => {
    var { style, placement, arrowProps, className = "", title, children } = _a, divProps = __rest(_a, ["style", "placement", "arrowProps", "className", "title", "children"]);
    return (React__default.createElement(motion.div, Object.assign({ ref: ref, style: style, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, "data-placement": placement, role: "tooltip", className: `popover bs-popover-${placement} ${className}` }, divProps),
        React__default.createElement("div", Object.assign({ className: "popover-arrow" }, arrowProps)),
        title && React__default.createElement("h3", { className: "popover-header" }, title),
        React__default.createElement("div", { className: "popover-body" }, children)));
});

const PopoverPopper = (_a) => {
    var { placement = "right", visible } = _a, popoverProps = __rest(_a, ["placement", "visible"]);
    return (React__default.createElement(AnimatePresence, null, visible && (React__default.createElement(Popper, { placement: placement }, (p) => (React__default.createElement(PopoverElement, Object.assign({}, popoverProps, p, { placement: placement })))))));
};

const Popover = (_a) => {
    var { trigger = ["click"], children, content, onToggle } = _a, props = __rest(_a, ["trigger", "children", "content", "onToggle"]);
    const [visible, set] = useSharedState(props.visible, onToggle);
    const triggers = {
        hover: {
            onMouseEnter: () => set(true),
    ...
    return (React__default.createElement(Manager, null,
        React__default.createElement(Reference, null, ({ ref }) => children(Object.assign({ ref }, (typeof trigger === "string" ? [trigger] : trigger)
            .map((t) => triggers[t])
            .reduce((obj, item) => {
            for (let i in item)
                obj[i] = item[i];
        ...
        React__default.createElement(PopoverPopper, Object.assign({}, props, { visible: visible }), content)));
};

const Progress = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement("div", Object.assign({ className: `progress ${className}` }, props, { ref: ref }), children));
});

const ProgressBar = forwardRef((_a, ref) => {
    var { className = "", variant = "solid", value = 0, children } = _a, props = __rest(_a, ["className", "variant", "value", "children"]);
    className = classnames(`progress-bar ${className}`, {
        "progress-bar-striped progress-bar-animated": variant === "stripe"
    });
    return (React__default.createElement("div", Object.assign({}, props, { "aria-valuenow": value, "aria-valuemin": 0, "aria-valuemax": 100, style: { width: `${value}%` }, role: "progressbar", className: className, ref: ref }), children));
});

const Spinner = forwardRef((_a, ref) => {
    var { className = "", variant = "border", size, color, children } = _a, props = __rest(_a, ["className", "variant", "size", "color", "children"]);
    className = classnames(`spinner-${variant} ${className}`, {
        [`text-${color}`]: color,
        [`spinner-${variant}-sm`]: size === "small" || size == "sm"
    });
    return (React__default.createElement("div", Object.assign({}, props, { className: className, ref: ref }),
        React__default.createElement(SR, null, "Loading...")));
});

const ToastBody = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `toast-body ${className}`, ref: ref }), children));
});

const ToastHeader = forwardRef((_a, ref) => {
    var { className = "", children } = _a, props = __rest(_a, ["className", "children"]);
    return (React__default.createElement("div", Object.assign({}, props, { className: `toast-header ${className}`, ref: ref }), children));
});

const Toast = forwardRef(({ className = "", dismissable = true, title, time, onDismiss, children, body, icon, duration = 5, key, }, ref) => {
    useEffect(() => {
        onDismiss && setTimeout(onDismiss, duration * 1000);
    }, [onDismiss]);
    return (React__default.createElement(motion.div, { ref: ref, className: `toast show ${className}`, role: "alert", "aria-live": "assertive", "aria-atomic": "true", initial: { opacity: 0, height: 0 }, animate: {
            opacity: 1,
            height: "auto",
            transition: { ease: "easeOut" },
        }, exit: { opacity: 0, transition: { duration: 0.2 } }, key: key },
        (icon || title || time || dismissable) && (React__default.createElement(ToastHeader, null,
            icon,
            title && React__default.createElement("strong", { className: "mr-auto" }, title),
            time && React__default.createElement("small", { className: "text-muted" }, time),
            dismissable && React__default.createElement(Close, { onClick: onDismiss, className: "ml-2 mb-1" }))),
        React__default.createElement(ToastBody, null,
            children,
            body),
        React__default.createElement(motion.div, { style: {
                position: "absolute",
                bottom: 0,
                left: 0,
                width: "auto",
...
const Toaster = forwardRef(({ className = "", children, duration = 5 }, ref) => {
    const index = useRef(0);
    const [items, setItems] = useState([]);
    useEffect(() => void children((props) => setItems((state) => [...state, Object.assign({ key: index.current++ }, props)]), (key) => setItems((state) => state.filter((i) => i.key !== key))), []);
    return (React__default.createElement("div", { className: className, style: {
        ...
        React__default.createElement(AnimatePresence, { initial: false }, items.map((p) => {
            return (React__default.createElement(Toast, Object.assign({}, p, { duration: p.duration || duration, onDismiss: () => setItems((state) => state.filter((i) => i.key !== p.key)) })));
        }))));
});

const TooltipElement = forwardRef((_a, ref) => {
    var { style, placement, arrowProps, className = "", children } = _a, divProps = __rest(_a, ["style", "placement", "arrowProps", "className", "children"]);
    return (React__default.createElement(motion.div, Object.assign({ ref: ref, style: style, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, "data-placement": placement, role: "tooltip", className: `tooltip bs-tooltip-${placement} ${className}` }, divProps),
        React__default.createElement("div", Object.assign({ className: "tooltip-arrow" }, arrowProps)),
        React__default.createElement("div", { className: "tooltip-inner" }, children)));
});

const TooltipPopper = (_a) => {
    var { placement = "top", visible = false } = _a, tooltipProps = __rest(_a, ["placement", "visible"]);
    return (React__default.createElement(AnimatePresence, null, visible && (React__default.createElement(Popper, { placement: placement }, (p) => (React__default.createElement(TooltipElement, Object.assign({}, tooltipProps, p, { placement: placement })))))));
};

const Tooltip = (_a) => {
    var { trigger = ["hover", "focus"], children, content, onToggle } = _a, props = __rest(_a, ["trigger", "children", "content", "onToggle"]);
    const [visible, set] = useSharedState(props.visible, onToggle);
    const triggers = {
        hover: {
            onMouseEnter: () => set(true),
    ...
    return (React__default.createElement(Manager, null,
        ...
        React__default.createElement(TooltipPopper, Object.assign({}, props, { visible: visible }), content)));
};

export { Accordion, Alert, AlertHeading, AlertLink, Badge, Breadcrumb, BreadcrumbItem, Button, ButtonGroup, ButtonToolbar, Card, CardBody, CardFooter, CardGroup, CardHeader, CardImage, CardLink, CardSubtitle, CardText, CardTitle, Carousel, CarouselCaption, CarouselItem, Close, Collapse, Dropdown, DropdownDivider, DropdownHeader, DropdownItem, DropdownItemText, DropdownMenu, DropdownToggle, Icon, ListGroup, ListGroupItem, Modal, ModalBackdrop, ModalBody, ModalContent, ModalDialog, ModalFooter, ModalHeader, ModalTitle, Nav, NavItem, NavLink, NavLinkToggle, Navbar, NavbarBrand, NavbarNav, NavbarText, NavbarToggler, Pagination, PaginationItem, Popover, PopoverElement, Manager as PopoverManager, PopoverPopper, Reference as PopoverReference, Progress, ProgressBar, SR, SimpleNavBar, Spinner, TabContent, TabPane, Toast, ToastBody, ToastHeader, Toaster, Tooltip, TooltipElement, Manager as TooltipManager, TooltipPopper, Reference as TooltipReference };
